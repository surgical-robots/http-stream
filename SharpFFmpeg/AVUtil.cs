...
namespace SharpFFmpeg
{
    public partial class FFmpeg
    {
        ...
        [DllImport("avutil.dll"), SuppressUnmanagedCodeSecurity]
        public static extern int av_frame_get_buffer(IntPtr pAVFrame, int align);

        [DllImport("avutil.dll"), SuppressUnmanagedCodeSecurity]
        public static extern int av_frame_make_writable(IntPtr pAVFrame);

        [DllImport("avutil.dll"), SuppressUnmanagedCodeSecurity]
        public static extern void av_frame_free(IntPtr pAVFrame);
